...
export function meta() {
  return [
    { title: "The Chemical Warfare Brigade | Biscuits Internet Project" },
    {
      name: "description",
      content:
    ...
    {
      property: "og:image",
      content: "https://pub-6aa5e67069a14fc286677addbdd10c65.r2.dev/public/cwb.jpg",
    },
  ];
}
...
const characters = [
  {
    ...
    description:
      "A large fellow from a very young age, Amos was raised in rural Tennessee. He is a rugged, handsome fellow, but has never been considered the brightest guy by his peers. He doesn't have many friends and spends a good deal of time drinking and fantasizing about what could have been had he decided to finish high school. Instead he dropped out so he could get a job and be a little more desirable to the very few women in the surrounding towns. Suffice it to say, many years later he is quite the opposite. He has very little actual ambition, very little money, and is extremely unsure of himself. Any time he really had had a chance with the ladies, he seemed to blow it. Meeting Shelby Rose seemed too good to be true, but he never thought twice when this sexy young woman threw herself at him one night at Albert Lai's compound… currently out of work, hasn't had any work since he had a job doing carpentry at Albert Lai's compound a few summers back. Seems to be trustworthy and considers himself a good friend of Lai's and to no one's surprise, Lai feels the same way...",
  },
  {
    name: "Albert Lai",
    initial: "AL",
...
const songs = [
  {
    ...
    lyrics: [
      "I never imagined that I'd use my talent like this.",
  ...
  },
  {
    ...
    lyrics: [
      "Springtime come, and the flowers bloom.",
  ...
  },
  {
    ...
    setting:
      "Back to the Doctor's point of view. More thoughts from the Doctor about his present situation. The Chemical Warfare Brigade, as he and Amos jokingly called the three of them in a drunken stupor one night, actually did represent the only chance that these guys had ever had for prosperity. At one point, the future was bright, but now the Doctor knows what the outcome of this all is going to be...",
    lyrics: [
  ...
  },
  {
    name: "Confrontation",
    setting:
      'This is the story of the end. This song explains why the Doctor had to take the life of Amos. It is among the Doctor\'s last moments alive. In the end chorus he claims, "And for the moments time I wish I had the nerve." And in the next moment he finds the nerve, and with the pull of the trigger, the story ends.',
    lyrics: [
    ...
    <div className="relative">
      ...
      <div className="relative overflow-hidden rounded-xl border border-purple-500/20 bg-gradient-to-br from-purple-950/40 to-purple-900/10 backdrop-blur-sm">
        ...
        <div className="p-6 md:p-8">
          ...
          {/* Content */}
          <div className="text-content-text-secondary leading-relaxed text-base md:text-lg">
            <p>{act.content}</p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-10 md:space-y-14">
      ...
      <div className="relative -mx-4 md:-mx-0 overflow-hidden rounded-none md:rounded-2xl">
        <div className="relative h-[200px] md:h-[300px]">
          <img
            src="https://pub-6aa5e67069a14fc286677addbdd10c65.r2.dev/public/cwb.jpg"
            alt="The Disco Biscuits - The Chemical Warfare Brigade"
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 md:p-8">
            ...
            <p className="text-purple-300/80 text-base md:text-lg mt-1 font-[Rajdhani] tracking-wide">
              The Second Rock Opera by The Disco Biscuits
            </p>
          </div>
        </div>
      </div>
