...
export default [
  ...
  layout("routes/shows/_layout.tsx", [
    ...prefix("shows", [
      ...
      route("top-rated/:year?", "routes/shows/top-rated.tsx"),
  ...
  ...prefix("api", [
    ...
    route("tracks/:trackId/flags", "routes/api/tracks/$trackId.flags.tsx"),
    route("tracks/:trackId/completions", "routes/api/tracks/$trackId.completions.tsx"),
    route("tracks/earlier-performances", "routes/api/tracks/earlier-performances.tsx"),
