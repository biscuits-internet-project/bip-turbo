-- 2010-04-23 F.M. Kirby Center: Jon Gutwillig on midi (not guitar) for the show.
-- The whole note is the lineup caveat (now structured), so clear it.
...
WHERE smi."show_musician_id" = sm."id" AND smi."instrument_id" = i."id"
  ...
  AND s."slug" = '2010-04-23-the-f-m-kirby-center-wilkes-barre-pa' AND mu."slug" = 'jon-gutwillig' AND i."slug" = 'guitar';
...
WHERE "slug" = '2010-04-23-the-f-m-kirby-center-wilkes-barre-pa'
